...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			paint.setColor(getResources().getColor(R.color.titlebar));
...
//			canvas.drawText(getResources().getString(R.string.scan_text), (frame.left+(float)20 *density), (float) (frame.bottom + (float)TEXT_PADDING_TOP *density), paint);
