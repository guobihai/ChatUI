package com.smart.chatui.https.listener.handler;
...
public abstract class ProgressHandler extends Handler {
    ...
    public abstract void resultMsg(UIProgressListener uiProgressListener, String msg);

    public abstract void errorMsg(UIProgressListener uiProgressListener, String msg);
}
