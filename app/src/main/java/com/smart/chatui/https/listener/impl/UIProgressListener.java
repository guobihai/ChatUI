 ...
 */
package com.smart.chatui.https.listener.impl;

import android.os.Handler;
import android.os.Message;

import com.smart.chatui.https.listener.ProgressListener;
import com.smart.chatui.https.listener.handler.ProgressHandler;
import com.smart.chatui.https.listener.model.ProgressModel;
...
public abstract class UIProgressListener implements ProgressListener {
    ...
    private static class UIHandler extends ProgressHandler {
        ...
        @Override
        public void resultMsg(UIProgressListener uiProgressListener, String msg) {
            if (uiProgressListener != null) {
                uiProgressListener.onResultMsg(msg);
            }
        }

        @Override
        public void errorMsg(UIProgressListener uiProgressListener, String msg) {
            if (uiProgressListener != null) {
                uiProgressListener.onErrorMsg(msg);
            }
        }
