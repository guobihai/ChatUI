...
import com.smart.chatui.adapter.EmotionGridViewAdapter;
import com.smart.chatui.adapter.EmotionPagerAdapter;
...
import com.smart.chatui.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private void initEmotion() {
        // 获取屏幕宽度
        int screenWidth = MyApplicationLike.screenWidth;
        // item的间距
        int spacing = ChatUtils.dp2px(getActivity(), 12);
        // 动态计算item的宽度和高度
