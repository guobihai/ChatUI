package com.smart.chatui.ui.views;
...
import com.smart.chatui.util.DbUtils;
...
/**
 * Created by gbh on 2018/5/4  17:49.
 *
 * @describe 分割线
 */
...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public TitleItemDecoration(Context context, List<Person> data) {
        super();
        mContext = context;
        mData = data;
        mPaint = new Paint();
    ...
    private void drawTitle(Canvas c, int left, int right, View child, RecyclerView.LayoutParams params, int position) {
        ...
        c.drawText(mData.get(position).getLetters(), child.getPaddingLeft()+ DbUtils.dip2px(mContext,10),
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {
        ...
        c.drawText(tag, child.getPaddingLeft()+ DbUtils.dip2px(mContext,10),
