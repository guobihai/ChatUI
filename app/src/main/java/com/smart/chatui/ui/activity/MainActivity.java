...
public class MainActivity extends AppCompatActivity {
    ...
    private void initUdp() {
        ...
        mUDPClientUtils = UDPClientUtils.getInstance(this, "mess.csosm.com",
                62280, dataBean.getDEVICE_ID(), "", "");
        mUDPClientUtils.setIp("mess.csosm.com");
        mUDPClientUtils.setPort("62280");
        mUDPClientUtils.setToDevicesId(dataBean.getDEVICE_ID());
        mUDPClientUtils.login(String.valueOf(dataBean.getLOGIN_ID()));
