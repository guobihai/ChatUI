...
//
//
//    @Generated(hash = 1127311779)
//    public HisContact(Long Id, String userName, String nickName, String conRemark, String iconUrl,
//            int type, String lastMsg, String createTime, String loginUserId, int orderCode,
//            int msgCount, int menberId, int code, String codeName) {
//        this.Id = Id;
